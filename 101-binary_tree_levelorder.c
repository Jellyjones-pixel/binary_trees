 ...
 *@tree: points to root node of tree to measure the height.
...
/**
 * print_at_level - print node, spcific level
...
/**
 * binary_tree_levelorder - passing throuhg a binary tree in level-order traversal
 * @tree: pointer to the root node of the tree to traverse
 * @func: pointer to a function to call for each node.
 */
